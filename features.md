...
- [ ] **T7 · `A.3 Ficha del sistema`** · Informe · `redactor-tfg`
  ...
  **infraestructura de cómputo**: i7-12700H, 34 GB RAM, Windows 11 Pro 10.0.26200, Python 3.11,
  ...
  → **La tabla de dispersión de T4 YA EXISTE (2026-08-13, ver `## Cerradas`):**
    ...
    `df30cb2-sucio`**, que se cita **re-anclado, no regenerado** (un artefacto que estampa
    `config.commit_actual()` no puede llevar el hash del commit que lo versiona).
