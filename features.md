...
| 2026-08-26 | Informe | **AVISO REGISTRADO — TRAMPA DE NUMERACIÓN (hallazgo 5 del cap. 1):** Snort es **`[26]` en el vault** y **`[11]` en el `.docx`**; pero en la numeración del `.docx` **`[26]` es LightGBM (Ke et al.)**, así que trasladar el `[26]` tal cual **no dejaría una cita huérfana sino una cita FALSA**. Se registra como aviso, **no se resuelve** | — |
| 2026-08-26 | Informe | **AVISO REGISTRADO — CANDIDATO QUE NO CUPO EN EL TOPE DEL CAP. 2:** el **bloque ético completo de `2.3.3`** (explicabilidad, privacidad, RGPD/AI Act/NIS2). Es **ausencia real** y queda como **primer candidato** si Francisco amplía el tope de 8 | — |
