...
>   **`02ff9fb`/este mismo** (TANDA 23, estados y totales de `00 Índice TFG.md`) ·
>   **`` `—` ``/`` `—` ``** (TANDA 24, tres fichas: nomenclatura de Procedencia en `4.2`, remisiones a
>   `4.3.5` y la mitad de P9 en `5.4`; el hash lo estampa el coordinador).
>
...
- [ ] 🟡 **`[54]` Molnar · edición sin fijar — NO SE TOCÓ en este pase** · Informe · **DECIDIDO — pendiente de aplicar** · ejecuta `researcher`
