...
>
> **Ciclos del 2026-08-17**, cada uno con su commit de trabajo y su commit de estampado:
> **`822e4c5`/`15665ae`** · **`198fab6`/`785fb40`** · **`8b5ce15`/`ac36b88`** · **`312c179`/`7f2645a`**
> · **`5c2a484`/`f9d8ce4`** (TANDA 20, séptimo re-anclaje de sello) · **`1075dfd`/este mismo**
> (TANDA 21, seis fichas).
>
