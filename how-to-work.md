...
* Al retomar el proyecto, verifica el estado real del código y de los artefactos en disco **antes** de proponer o ejecutar nada. No te fíes de la prosa de `features.md` —el registro operativo vivo desde el 2026-08-01— ni de la bitácora de `next-steps.md`, que está congelada: pueden ir por detrás del código. Si divergen, el **código/disco es la fuente de verdad** y hay que reconciliar el documento.
