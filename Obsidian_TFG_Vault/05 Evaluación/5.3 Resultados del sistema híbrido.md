...
*(Nota: el híbrido no produce un recall por clase a 5 clases directamente comparable —sus errores incluyen el enrutado a `unknown`—; su rendimiento por categoría conocida se reportó como macro en el segundo apartado, y la comparación por clase puede leerse en las matrices de confusión de las Figuras 5.12 y 5.13.)*

![[hibrido_cm_54.png]]

Figura 5.12. Matriz de confusión del sistema híbrido sobre D2, reproducida aquí para su confrontación directa con la del baseline monolítico.

![[baseline_cm_54.png]]

Figura 5.13. Matriz de confusión del baseline de control (RandomForest monolítico de 5 clases) sobre D2, con 54 características.

> [!todo] Figura repetida dentro de 5.3 — decisión pendiente
> Las Figuras 5.11 y 5.12 embeben el mismo fichero (`hibrido_cm_54.png`). Se han numerado como
> instancias propias para que ningún embebido quede sin pie, pero en el volcado al `.docx` la
> misma imagen aparecería dos veces con dos números distintos. Queda pendiente decidir si la
> segunda aparición se sustituye por una remisión a la Figura 5.11; hacerlo implica retocar la
> prosa del apartado y excede el alcance de este pase.
