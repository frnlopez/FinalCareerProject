...
La pregunta natural al cerrar la evaluación es cómo se sitúa este sistema frente a las cifras publicadas sobre el mismo dataset. La respuesta corta es que **casi ninguna de esas cifras es comparable**, y el apartado que sigue explica por qué en lugar de esconderlo tras una tabla larga de *accuracies*. El material de respaldo, con las fuentes revisadas una a una, está en [[benchmark-comparativo-nsl-kdd]].
