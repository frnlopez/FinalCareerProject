...
>
> Este aviso cubre **solo la decisión de esta etapa**. En total son **tres** las decisiones del sistema tomadas mirando D2: esta (H-3), la de la etapa 1 (H-2, en [[5.1 Resultados del modelo de detección de anomalías|5.1]]) y la del **set de características, 54 frente a 122** (Q1/C, experimento H1), registrada en [[4.3 Preprocesamiento de los datasets|4.3.5]] § Decisión experimental. El inventario completo está en [[6.1 Conclusiones]].
>
