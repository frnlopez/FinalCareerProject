...
**Remisión.** El alcance y las cifras de la desviación relativa al set de características (54 frente a 122) se fijan en su sede canónica, [[4.3 Preprocesamiento de los datasets|4.3.5]] § «Decisión experimental: 54 frente a 122 (experimento H1, medido sobre D2)»; aquí solo se enuncia la desviación de *data snooping* que implica, sin fijar por cuenta propia su alcance ni el veredicto de la comparación (las cifras del punto de operación que sí se citan más abajo proceden de esa misma sede y de `Resultados\metricas_hibrido.csv`).
