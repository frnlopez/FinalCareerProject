...
Es el criterio que la literatura de fugas señala como el más frecuentemente incumplido, precisamente porque el fallo típico —ajustar el escalador sobre el dataset completo antes de partirlo— es cómodo y no produce ningún error visible —categoría de preprocesado previo al *split* en la taxonomía de fugas [17]—.
