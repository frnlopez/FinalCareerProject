...
> [!info] Trazabilidad
> - **Tamaños de particiones y composición de D2:** `Resultados\metricas_hibrido.csv` (`n_conocida` = 9.083, `n_0day` = 3.750 y `bin_tn + bin_fp` = 9.711), `Resultados\metricas_baseline.csv` (`n_test` = 22.544) y `Resultados\metricas_hibrido_0day.csv`, que enumera uno a uno los 17 tipos 0-day.
> - **FPR por variante:** `Resultados\metricas_hibrido.csv`, columna `bin_fpr` (0,10174 y 0,084852).
