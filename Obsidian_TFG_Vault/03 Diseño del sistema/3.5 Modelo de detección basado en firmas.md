...
> [!info] Trazabilidad
> Selección de los cuatro algoritmos, extracción de reglas legibles y tratamiento del desbalance de clases son decisiones de la fase de diseño, justificadas en este mismo apartado; el contraste empírico entre las estrategias de balanceo se recoge en [[4.3 Preprocesamiento de los datasets]]. Implementación en `Implementacion/app/firmas.py`.
