...
A esa evidencia externa se suma una comprobación interna con los datos del propio trabajo, enunciada en la forma en la que sí se sostiene: **RandomForest supera a HistGradientBoosting en 8 de las 10 semillas, en las dos variantes de características**. Es una observación **pareada** —semilla a semilla—, y es esa forma pareada, no la diferencia de medias, la que aporta el apoyo.
...
- **Entrenamiento.** HistGradientBoosting resulta más caro de entrenar que RandomForest en **8 de los 10 pares intra-corrida medidos**, con rejillas de igual cardinalidad. Los **dos contraejemplos se dan ambos en la variante de 54 características**, de modo que la afirmación **solo es sólida en la variante de 122**.
