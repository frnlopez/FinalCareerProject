...
> [!info] Trazabilidad
> Arquitectura decidida en la fase de diseño —cascada anomalías→firmas, con la etapa 1 como filtro de novedad y la etapa 2 como etiquetador de lo ya conocido, según se justifica en este mismo apartado— e implementada en `Implementacion/app/hibrido.py`. Los diagramas de bloques del pipeline completo están en `Implementacion/PIPELINE.md` (`diagramas/`).
