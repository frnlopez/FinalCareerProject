...
> [!info] Trazabilidad
> Requisitos derivados de los objetivos del proyecto ([[1.3 Objetivo]]) y de las decisiones de diseño adoptadas al cerrar la fase de diseño, que este capítulo desarrolla: la arquitectura en cascada ([[3.2 Arquitectura del sistema]]), la partición especializada en D1/D2/D3 ([[3.3 Metodología de funcionamiento del sistema]]) y la elección de algoritmos de cada etapa ([[3.4 Modelo de detección de anomalías]] y [[3.5 Modelo de detección basado en firmas]]). El apartado 3.1.5 recoge y sistematiza el enunciado que hasta ahora solo existía, de forma dispersa, en el límite 3 de [[6.1 Conclusiones]].
