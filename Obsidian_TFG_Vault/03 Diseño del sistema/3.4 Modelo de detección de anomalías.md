...
> [!info] Trazabilidad
> Selección de los cuatro algoritmos y del criterio de umbral —percentil 95 del score sobre el subconjunto de validación de D1— son decisiones de la fase de diseño, justificadas en este mismo apartado. Implementación en `Implementacion/app/anomalias.py`.
