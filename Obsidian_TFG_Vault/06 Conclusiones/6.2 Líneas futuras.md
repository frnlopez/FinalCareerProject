...
> el que mejor generaliza [CITA: Erickson et al., TabArena, NeurIPS 2025, sección de análisis de
> *ensembles*]. Trasladado a este sistema, el riesgo concreto es decidir qué detectores entran —o
...
[CITA: reconocimiento de conjunto abierto, Bendale y Boult 2016, OpenMax]. Es la vía que ataca
...
- El ***target encoding*** sustituye cada categoría por un estadístico de la etiqueta condicionado a
  esa categoría, y por tanto **necesita una etiqueta con más de un valor** [CITA: Micci-Barreca 2001,
  *target encoding* para categóricas de alta cardinalidad / Pargent et al. 2022].
...
del IDS de firmas [CITA: Hwang, Cai, Chen y Qin 2007, esquema de generación de firmas ponderadas].
...
benigno y ataques en los cuatro restantes [CITA: Sharafaldin, Lashkari y Ghorbani 2018, ICISSP —
ficha del dataset CIC-IDS2017]. Eso habilita de golpe la división cronológica real y la curva de
...
> [CITA: Moustafa y Slay 2015, MilCIS — dataset UNSW-NB15]. Ahora bien, **este trabajo no ha podido
...
en despliegue [CITA: Pendlebury, Pierazzi, Jordaney, Kinder y Cavallaro 2019, USENIX Security —
restricciones de diseño y métrica AUT]. Un dataset sin marca de tiempo sencillamente **no admite ese
...
> El paradigma de *Nested Learning* [CITA: Behrouz, Razaviyayn, Zhong y Mirrokni, NeurIPS 2025 —
> §4.5, supuesto no i.i.d., y §9, evaluación] sitúa su aportación en el aprendizaje sobre secuencias
