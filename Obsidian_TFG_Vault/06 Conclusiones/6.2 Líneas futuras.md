...
> [!todo] Confirmar la procedencia de la cifra del 13,4 %
> El dato procede del registro de la ejecución del 2026-07-15 recogido en `EL_FUTURO.md`, pero
> **no hay hoy una columna en `Resultados/` que lo publique**. Antes de llevarlo a la memoria hay
> que reproducirlo desde `hibrido.py` y dejarlo en una tabla, o retirar la cifra y enunciar la línea
