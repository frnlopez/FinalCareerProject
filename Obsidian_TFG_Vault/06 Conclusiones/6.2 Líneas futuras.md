...
> [!todo] Dos huecos detectados, pendientes de decidir si entran
> Ninguno de los dos se redacta aquí sin decisión previa, porque ampliar el listado exige comprobar
> antes que cumplen el criterio de admisión de esta sección. Las remisiones que los prometían ya se
> han retirado de las notas emisoras, de modo que **ninguna de estas dos líneas queda anunciada como
> contenido de esta sección**.
> 1. **Cronometraje del extractor de características sobre tráfico crudo**, como vía para acotar el
>    caudal de extremo a extremo de un despliegue en línea. Lo motiva la salvedad de
>    [[5.4 Conclusiones del capítulo]], § «Qué NO mide la latencia publicada», que hoy se remite al
>    lector desde `2.2.3` § «Encaje en el trabajo» pero **no tiene aquí una línea futura que la
>    recoja**. La remisión que sí prometía esa línea estaba en `2.2.3` § 2.2.3.3.
> 2. **Validación cruzada entre datasets** —entrenar sobre un corpus y evaluar sobre otro— como
>    única prueba real de generalización. Sería consecuencia del peldaño 1 de § 6.2.6, no un
>    sustituto suyo. Las remisiones estaban en `2.3.2` § 2.3.2.5 y en `4.2`, punto 5.
