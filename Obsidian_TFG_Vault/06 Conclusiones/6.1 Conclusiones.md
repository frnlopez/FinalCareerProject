...
- *Objetivo 4.* La etapa 1 se entrenó exclusivamente con tráfico normal y se comparó **cuatro
  ...
  garantía metodológica de esa elección es menor** y así queda declarado en 6.1.3, que es su sede
  de referencia.
...
- **Tres decisiones del sistema se tomaron con métricas medidas sobre el test.** La disciplina anti-*leakage* del trabajo es acotada: D2 no se usó para ajustar hiperparámetros, la estrategia de balanceo ni los umbrales (se respetó en las dos etapas), pero quedan fuera de esa garantía tres elecciones que sí se resolvieron mirando D2:
	...
	Las tres son, formalmente, selección de modelo sobre el conjunto de test, es decir *data snooping*, y por tanto **las métricas publicadas son optimistas respecto a lo que daría un test verdaderamente ciego**. Esta enumeración de las tres decisiones es la **versión de referencia** del trabajo: los capítulos de diseño, implementación y evaluación remiten a este apartado en lugar de repetirla, de modo que su contenido no debe reducirse sin actualizar antes esas remisiones. Se declara además en [[2.1.6 Metodologías y buenas prácticas|2.1.6]] y [[5.4 Conclusiones del capítulo|5.4]], y, **cada una en su etapa**, en [[5.1 Resultados del modelo de detección de anomalías|5.1]] y [[5.2 Resultados del modelo de detección basado en firmas|5.2]]. En [[A.3 Ficha del sistema]] (§A.3.7) existe además un **volcado tabulado** —más detallado, decisión por decisión— de estas mismas tres elecciones, que remite a este apartado como sede canónica: la tabla es una vista, esta enumeración es la versión de referencia. Corregirlo exigiría un tercer conjunto de selección independiente de D2, ausente en el diseño oficial del NSL-KDD.

	**Remisión.** Este apartado es la sede de referencia del **inventario** de las tres decisiones, pero no de la tercera en particular: el alcance y las cifras de la desviación relativa al set de características (54 frente a 122) se fijan en su sede canónica, [[4.3 Preprocesamiento de los datasets|4.3.5]] § «Decisión experimental: 54 frente a 122 (experimento H1, medido sobre D2)», a la que aquí se remite sin fijar cifras ni alcance por cuenta propia.
