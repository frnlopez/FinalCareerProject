...
- **La elección del algoritmo ganador de cada etapa se hizo con métricas sobre el test.** La disciplina anti-*leakage* del trabajo es acotada: D2 no se usó para ajustar hiperparámetros ni umbrales (se respetó en las dos etapas), pero la comparación final entre los cuatro candidatos de cada etapa —la que seleccionó el Autoencoder y el RandomForest— se resolvió con métricas medidas sobre D2. Es, formalmente, una selección de modelo sobre el conjunto de test, y obliga a leer las cifras de los dos ganadores como optimistas por selección. Se declara en [[5.1 Resultados del modelo de detección de anomalías|5.1]] y [[5.2 Resultados del modelo de detección basado en firmas|5.2]]; corregirlo exigiría un tercer conjunto de selección, ausente en el diseño oficial del NSL-KDD.
