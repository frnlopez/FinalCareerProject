...
El panorama de amenazas ha cambiado desde que se capturó el tráfico que originó KDD'99: las familias dominantes hoy no son las que el dataset representa. **Esa distancia entre el catálogo del dataset y la amenaza actual es una limitación del trabajo y se declara como tal en [[6.1 Conclusiones|6.1]];** aquí basta con enunciarla, porque ninguna decisión de diseño de este sistema depende de un inventario de amenazas contemporáneas.
