...
La taxonomía anterior se fijó en 1998. Antes de defender su vigencia conviene describir, aunque sea de forma sintética y sin pretensión de exhaustividad, el escenario de amenazas contemporáneo.

> [!warning] Atribución RETIRADA el 2026-08-18 — cita `[37]` irreconstruible
> Esta frase describía el escenario «tal como lo recogen los informes periódicos de los organismos de
> referencia europeos y nacionales», apoyada en `[37]`, una de las **cinco citas colgantes
> irreconstruibles**: se identificaba la clase de documento (informe anual de organismo público) pero
> **nunca su edición**. **Francisco ha decidido retirar la atribución, no reetiquetarla.** Lo que
> queda es la caracterización cualitativa de los cuatro bloques, que **no incorpora ninguna cifra** y
> no se presenta ya como recogida de un informe concreto. La entrada `[37]` **no se borra ni se
> renumera** en `Bibliografía.md`; queda marcada como sin uso en el texto.
...
> [!note] Sin fuente citada, y a propósito (2026-08-18)
> La verificación que aquí quedaba pendiente **ya no procede**: el informe anual de organismo público
> en que se apoyaba este apartado (`[37]`) nunca se pudo identificar, y la atribución **se retiró**
> por decisión de Francisco. La caracterización de los cuatro bloques se mantiene como descripción
> cualitativa **sin cifras y sin cita**; si se quiere avalar, el alta de la fuente la haría el
> `researcher` una vez fijada la edición.

> [!note] Alcance declarado: caracterización cualitativa
> Se opta deliberadamente por **no cuantificar** el panorama de amenazas (decisión del 2026-08-15). Cualquier magnitud publicada —p. ej. el peso relativo del ransomware sobre el total de incidentes notificados— exigiría fijar y verificar la edición del informe de origen frente a su texto completo, y esta redacción no dispone de ese acceso; una cifra sin verificar no se incorpora, aunque estuviera disponible de memoria o por aproximación. La cifra nunca fue necesaria para sostener el argumento de la sección, que es de naturaleza cualitativa. La decisión es reversible: si se confirma la edición efectivamente consultada, la magnitud podrá añadirse sin alterar el resto del apartado.
