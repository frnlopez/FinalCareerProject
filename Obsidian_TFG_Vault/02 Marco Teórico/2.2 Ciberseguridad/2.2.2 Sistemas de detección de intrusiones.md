...
> [!note] Qué dos de las tres recoge este TFG
> De las tres familias, el proyecto encadena las dos primeras en lugar de elegir entre ellas. La **etapa de anomalías** hereda de Denning la idea de modelar lo normal y señalar la desviación; la **etapa de firmas**, que produce reglas legibles extraídas de un árbol de decisión, entronca con la tradición de Snort, con la diferencia de que aquí las reglas no las escribe un analista sino que se **aprenden de los datos**. La justificación de esa combinación se desarrolla en [[2.2.4 Detección por firmas frente a detección por anomalías]].
