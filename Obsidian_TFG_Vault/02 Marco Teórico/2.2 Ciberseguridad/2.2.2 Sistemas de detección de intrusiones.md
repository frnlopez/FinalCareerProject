...
> `[26]` es el artículo con que Roesch presentó **Snort** en LISA'99, de modo que avala esa herramienta y no las posteriores: la mención de **Suricata y Zeek/Bro** (2009 en adelante) queda como histórico no controvertido, **sin aval explícito y sin cita inventada**. Por la misma razón, la línea temporal **no cierra** con el IDS como fuente de plataformas SIEM/XDR: esa afirmación se apoyaba en una fuente que no pudo identificarse y se ha retirado en lugar de reetiquetarla.
...
> Fijados aquí la definición, la evolución del concepto, la distinción IDS/IPS y los componentes funcionales, la clasificación de estos sistemas continúa en [[2.2.3 Taxonomía de los IDS]].
