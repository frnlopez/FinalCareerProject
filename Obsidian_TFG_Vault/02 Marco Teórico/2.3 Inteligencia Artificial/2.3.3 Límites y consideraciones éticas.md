...
La cadena tiene una lectura incómoda y necesaria: **un detector con métricas de laboratorio excelentes puede resultar inutilizable, e incluso contraproducente, en un centro de operaciones real**. La métrica agregada —una AUC alta, una exactitud alta— no mide utilidad operativa, porque no incorpora ni la prevalencia real ni el coste del triaje. De ahí se sigue el criterio metodológico que este trabajo adopta: **ninguna cifra de recall se reporta sin su tasa de falsos positivos**, y el punto de operación se declara siempre de forma explícita. El recall y la tasa de falsos positivos (FPR) se calculan sobre poblaciones distintas —el primero dentro de la clase de ataque, la segunda dentro de la clase normal— y ninguna de las dos es interpretable sola: subir un umbral mejora una a costa de la otra, de modo que una cifra de recall sin su FPR no describe un detector, sino un punto arbitrario de una curva. La definición formal de ambas a partir de la matriz de confusión, y la razón detallada de por qué no son complementarias, se dan en [[2.1.5 Métricas de evaluación]], en particular en 2.1.5.4.
...
> Este trabajo expone el **enfoque basado en riesgo** del AI Act y sus **obligaciones transversales** —gestión de riesgos, calidad de los datos, documentación técnica, transparencia y supervisión humana—, pero **no determina en qué categoría cae el sistema desarrollado**. Hacerlo exigiría leer el texto consolidado y sus anexos en EUR-Lex, cosa que no se ha hecho en esta redacción, y afirmar una categoría de riesgo sin ese respaldo sería precisamente el tipo de afirmación sin sustento que este trabajo evita en cualquier otro terreno. La omisión no compromete la tesis de este apartado: el argumento de que la supervisión humana es parte de la definición del sistema se sostiene con el enfoque basado en riesgo y las obligaciones generales, sin necesidad de fijar la categoría exacta. Es una limitación declarada, no una tarea pendiente; reversible si en el futuro se consulta el texto oficial.
