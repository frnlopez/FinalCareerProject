...
Como referencia de partida, la **regresión logística** modela el logaritmo de la razón de probabilidades como una combinación lineal de las características y sirve de línea base explicable en clasificación, pero **no forma parte de este sistema**: su desarrollo está en [[A.3 Ficha del sistema]] § A.3.10.1 [5, cap. 4].

### 2.1.4.1.1 Árboles de decisión
...
### 2.1.4.1.2 Bosques de decisión: Random Forest y Gradient Boosting
...
### 2.1.4.1.3 k vecinos más cercanos (k-NN)
