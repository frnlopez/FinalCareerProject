...
Esta distinción —reglas escritas a mano frente a reglas inducidas de los datos— se retoma, aplicada a la detección de intrusiones, en [[2.3.1 IA, ML y Deep Learning|2.3.1]] (§2.3.1.3).
