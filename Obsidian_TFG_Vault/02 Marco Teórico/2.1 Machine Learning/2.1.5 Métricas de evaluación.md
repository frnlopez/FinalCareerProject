...
> [!note] Reparto con el Apéndice A.2
> Aquí se define **qué mide cada métrica y por qué se eligió**; las **fórmulas** viven en [[A.2 Métricas de desempeño|A.2]]. El reparto completo lo declara `A.2` y no se repite aquí.
...
Este trabajo **no reporta** métricas de regresión (MAE, RMSE) ni de agrupamiento (coeficiente de silueta), porque no resuelve ninguna de esas dos tareas. **Ambas familias están definidas en [[A.2 Métricas de desempeño|A.2]] (§A.2.2)**, para completitud del marco.
