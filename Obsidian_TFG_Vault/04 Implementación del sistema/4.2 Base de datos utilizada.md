...
> **4.2.1 (análisis previo)**: volcado de EDA/validación en `borrador` (Claude, 2026-07-16). **Parte teórica de 4.2** (origen del dataset, 41 features, por qué NSL-KDD): borrador redactado por Claude el 2026-07-21 (reparto de teoría cedido por acuerdo de esa fecha), cuyos marcadores `[CITA:...]` se convirtieron a `[n]` de [[Bibliografía]] en el pase en serie del 2026-08-15; el bloque «Por qué se eligió NSL-KDD» queda a revisión de Francisco por reflejar el criterio del autor.
...
> Bloques «Origen» y «Características» redactados por Claude (2026-07-21) como borrador factual; el bloque «Por qué se eligió NSL-KDD» refleja el criterio del autor y queda pendiente de revisión de Francisco. Las referencias de este apartado ya están numeradas contra [[Bibliografía]]: `[22]`, `[23]`, `[31]`, `[58]` y `[59]`.
