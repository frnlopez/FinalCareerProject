...
>
> *Tres decisiones del sistema se tomaron mirando D2: el detector de la etapa 1, el clasificador de la etapa 2 y el set de características (54 frente a 122). Las tres son selección de modelo sobre el conjunto de test, es decir* data snooping, *y por tanto las métricas publicadas son optimistas respecto a lo que daría un test verdaderamente ciego.* Su alcance y sus cifras se fijan en [[4.3 Preprocesamiento de los datasets|4.3.5]] § *Decisión experimental*, y el inventario completo, como limitación del trabajo, en [[6.1 Conclusiones|6.1]] (§6.1.3); **el detalle de cada una no se reproduce aquí**.
