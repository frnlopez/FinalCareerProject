...
- La **selección de características** (§4.3.5) redujo de 122 a 54 características y resultó tener un doble efecto beneficioso —menor dimensionalidad y **mejor generalización** del clasificador de firmas—, **decidido por el experimento H1 del capítulo 5, con métricas sobre D2** (véase el aviso de esta nota).
