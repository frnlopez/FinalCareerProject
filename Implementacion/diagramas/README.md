...
| Fichero | Contenido |
|---|---|
| `01_pipeline_completo.mmd` | Flujo completo: `program.py` (preprocesado + splits D1/D2/D3) → `validacion.py` → modelos futuros |
...
- **Obsidian:** el Markdown de `PIPELINE.md` ya los renderiza en vista previa.
